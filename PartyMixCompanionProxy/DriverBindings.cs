...
namespace PartyMixCompanionProxy {
  ...
  public class TeVirtualMIDI {
    ...
    private
    const UInt32 TE_VM_DEFAULT_SYSEX_SIZE = 65535;

    /* constant for loading of teVirtualMIDI-interface-DLL, either 32 or 64 bit */
    private
    const string DllName = "teVirtualMIDI.dll";
